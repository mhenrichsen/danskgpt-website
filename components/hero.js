        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              DanskGPT er en sprogmodel, der kan hjælpe dig med at
              udnytte det fulde potentiale af virksomhedens data. Med
              DanskGPT kan du effektivt udtrække værdifuld information fra
              virksomhedens data, og dermed skabe værdi for virksomheden.
            </p>
          </div>
        </div>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Udviklet til at være kompatibel med alle cloud platforme
          </div>
